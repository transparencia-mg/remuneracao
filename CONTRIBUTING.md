...
- [Issues](https://github.com/dados-mg/diarias/issues): Para iniciar uma discussão sobre melhorias na documentação.
- [Pull requests](https://github.com/dados-mg/diarias/pulls): Para sugerir uma alteração concreta na documentação.
